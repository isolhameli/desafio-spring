...
import com.mercadolibre.desafiospring.exceptions.util.ParamRequirements;
...
public class ControllerExceptionHandler {
    ...
    public ResponseEntity<StandardError> entityError(EntityException e, HttpServletRequest httpServletRequest){
